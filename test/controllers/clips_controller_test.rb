...
class ClipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clip" do
    assert_difference("Clip.count") do
      post clips_url, params: { clip: { cat_id: @clip.cat_id, email: @clip.email, link: @clip.link, region: @clip.region, video: @clip.video } }
    end
  ...
  test "should update clip" do
    patch clip_url(@clip), params: { clip: { cat_id: @clip.cat_id, email: @clip.email, link: @clip.link, region: @clip.region, video: @clip.video } }
